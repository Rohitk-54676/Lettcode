...
This solution was accepted on LeetCode using Daily Question. The detected topics are Array, Union-Find, Sorting. Review the synced source file for the implementation details.
